...
int VertexBufferAndShader::run()
{
	...
	GLsizei mem_address_width = sizeof(float) * num_floats_per_vertex; // num bytes for each vert in mem
	...
	// glsl, opengl shader language, version 330, core no deprecared functions
	...
	std::string fragmentShader =
		...
		"void main()\n"
		"{\n"
		"	color = vec4(0.0, 0.0, 0.64, 1.0);\n" // generally rgba, HDR has larger range
		"}";
