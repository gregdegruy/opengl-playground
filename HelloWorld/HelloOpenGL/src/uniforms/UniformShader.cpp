...
UniformShaderProgramSource UniformShader::parseShader(const std::string& filePath)
{
...
unsigned int UniformShader::compileShader(unsigned int type, const std::string& source)
{
	...
	if (result == GL_FALSE) {
		...
		std::cout << "\nERROR UniformShader::compileShader for type " <<
...
unsigned int UniformShader::createShader(const std::string& vertexShader, const std::string& fragmentShader)
{
