...
DebugShaderProgramSource DebugShader::parseShader(const std::string& filePath)
{
...
unsigned int DebugShader::compileShader(unsigned int type, const std::string& source)
{
...
unsigned int DebugShader::createShader(const std::string& vertexShader, const std::string& fragmentShader)
{
