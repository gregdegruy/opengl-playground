...
ShaderProgramSource ShaderOpt::parseShader(const std::string& filePath)
{
...
unsigned int ShaderOpt::compileShader(unsigned int type, const std::string& source)
{
...
unsigned int ShaderOpt::createShader(const std::string& vertexShader, const std::string& fragmentShader)
{
